...
1. Clone the project: [https://github.com/dat3Cph/hotel_exercise_rest](https://github.com/dat3Cph/hotel_exercise_rest) and get it running on your local dev-setup.
